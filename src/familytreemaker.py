...
class Person:
	...
	def graphviz(self):
		...
		opts.append('fillcolor=' + ('F' in self.attr and 'pink' or
					('M' in self.attr and 'lightblue' or 'white')))
...
def main():
	...
	parser.add_argument('input', metavar='INPUTFILE', default='ShanmugamFamily.txt',
